        ...
        for d1 in ["d", "r", "f"]:
            for d2 in ["d", "r", "f"]:
                ...
                for flag_int in range(4):
                    for b in [False, True]:
                        magic_list.append(magic412(2, 6, d1, d2, flag_int, False, b, add=_add, curl=curl))
                        magic_list.append(magic412(3, 6, d1, d2, flag_int, False, b, add=_add, curl=curl))
                        magic_list.append(magic412(2, 6, d1, d2, flag_int, True, b, add=_add, curl=curl))
                        magic_list.append(magic412(3, 6, d1, d2, flag_int, True, b, add=_add, curl=curl))
