...
def solve_bruce_41(initial_state: List[str], goal_state: List[str], two_side: bool):
    # ABAB, N1等には使えない
...
def test_phase1(initial_state, goal_state):
    path = solve_bruce_41(initial_state, goal_state, two_side=True)
    print(path)
...
def test_phase2(initial_state, goal_state):
    path = solve_bruce_41(initial_state, goal_state, two_side=False)
    print(path)
...
if __name__ == "__main__":
    ...
    for _i, _row in puzzles_df_pick.iterrows():
        ...
        _path = solve_bruce_41(_initial_state_pick_mask, _goal_state_pick, two_side=True)
        for _m in _path:
            _q4.operate(_m)
        ...
        _path = solve_bruce_41(_initial_state_pick, _goal_state_pick, two_side=False)
        for _m in _path:
            _q4.operate(_m)
        print(_q4.state)
