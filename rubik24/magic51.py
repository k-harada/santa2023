...
if __name__ == "__main__":
    ...
    # _path = magic51(1, 2, _n, "d", "r", flag_int=0)
    # ['d1', 'r0', 'd2', '-r0', '-d1', 'r0', '-d2', '-r0']  # [36, 67, 42]
    # _path = ['d3', 'r0', 'd2', '-r0', '-d3', 'r0', '-d2', '-r0']  # [32, 38, 57]
    # _path = ['d3', 'd1', 'r0', 'd2', '-r0', '-d3', '-d1', 'r0', '-d2', '-r0']  # [32, 38, 57], [36, 67, 42]
    # _path = ['f1', 'r0', 'f2', '-r0', '-f1', 'r0', '-f2', '-r0']  # [11, 61, 17]
    # _path = ['f1', 'd1', 'r0', 'f2', 'd2', '-r0', '-f1', '-d1', 'r0', '-f2', '-d2', '-r0']  これはだめ
    _path = ['-d3', 'd1', 'r0', 'd2', '-r0', 'd3', '-d1', 'r0', '-d2', '-r0']  # [38, 57, 82]
    print(_path)
