...
def magic412(
    ...
    res_path = [f"{f0}{d1}{k}"] * c + [
        f"{f2}{d2}{v}"] + [f"{f1}{d1}{k}"] * c + [f"{f3}{d2}{v}"] + [f"{f0}{d1}{k}"] * c + [
        f"{f3}{d2}{v}"] + [f"{f1}{d1}{k}"] * c + [f"{f2}{d2}{v}"]
    if 0 < add < 3:
        res_path = [f"{f3}{d2}{v}"] * add + res_path + [f"{f2}{d2}{v}"] * add
    elif add == 3:
        res_path = [f"{f2}{d2}{v}"] + res_path[:-1]
    if curl == 1:
        res_path = [f"-{d3}0"] + res_path + [f"{d3}0"]
    elif curl == -1:
        res_path = [f"{d3}0"] + res_path + [f"-{d3}0"]
